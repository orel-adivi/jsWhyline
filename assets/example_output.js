...
function not_called(param) {
    ...
    const b = 6;
    const c = 7;
    Logger.exit_function_implicitly('not_called', 82);
}
function called(param) {
    Logger.enter_function('called', 86);
    const d = 8;
    Logger.exit_function_explicitly('called', 188, 9);
    return 9;
    Logger.exit_function_explicitly('called', 202, 'a');
    return 'a';
    let e = 10;
    Logger.exit_function_implicitly('called', 224);
}
let f = 11;
called(12);